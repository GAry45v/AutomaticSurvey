...
def paras_args():
    ...
    parser.add_argument('--topic',default='Image Fusion', type=str, help='Topic to generate survey for')
    parser.add_argument('--requirement',default='文献应该包括2023和2024年的paper', type=str, help='Specific requirements')
