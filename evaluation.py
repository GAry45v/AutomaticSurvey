...
def paras_args():
    ...
    parser.add_argument('--model',default='o3-mini', type=str, help='Model for evaluation')
    parser.add_argument('--topic',default='LLMs for education', type=str, help='Topic of the survey')
